...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        uses QHBoxLayout which will be applied to the container before adding any labels. By its' name, the
        elements will be displayed horizontally, where their positions will be mentioned using numbers in this
        code example
        '''
